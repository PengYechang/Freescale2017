...
#define OLED_SCLK_PIN 15

#define OLED_CS_PORT   HW_GPIOA
#define OLED_DC_PORT   HW_GPIOA
#define OLED_RES_PORT  HW_GPIOA
#define OLED_SDIN_PORT HW_GPIOA
#define OLED_SCLK_PORT HW_GPIOA

#define OLED_CS_H    PAout(OLED_CS_PIN) = 1
#define OLED_CS_L    PAout(OLED_CS_PIN) = 0
#define OLED_RES_H   PAout(OLED_RES_PIN) = 1
#define OLED_RES_L   PAout(OLED_RES_PIN) = 0
#define OLED_DC_H    PAout(OLED_DC_PIN) = 1
#define OLED_DC_L    PAout(OLED_DC_PIN) = 0
#define OLED_SCLK_H  PAout(OLED_SCLK_PIN) = 1
#define OLED_SCLK_L  PAout(OLED_SCLK_PIN) = 0
#define OLED_SDIN_H  PAout(OLED_SDIN_PIN) = 1
#define OLED_SDIN_L  PAout(OLED_SDIN_PIN) = 0
